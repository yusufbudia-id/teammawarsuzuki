            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex justify-between items-end mb-10">
                ...
                <Link href="/produk" className="hidden md:flex items-center text-primary font-semibold hover:underline">
                  Lihat Semua Katalog <ArrowRight className="ml-2 w-4 h-4" />
                </Link>
              </div>
                      ...
                      >
                        <div className="relative aspect-[4/3] overflow-hidden shrink-0">
                          ...
                          <Image
                            ...
                            fill
                            className="object-cover block group-hover:scale-105 transition-transform duration-700 ease-out"
                          />
